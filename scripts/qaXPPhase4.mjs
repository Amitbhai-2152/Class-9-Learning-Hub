...
console.log('XP Phase 4 QA passed: canonical dashboard state, legacy XP write removal, global routed completion integration, Reasoning/English route support, verified CBT message bridge, reward persistence, and CI script wiring verified.');
