...
checkPoem({path:'src/english/EnglishPanoramaPoem7.jsx',title:'I Am Like Grass',poet:'Pash',chapter:7,excerpts:['I am like grass','but I shall sprout again','you cannot erase my identity','it will be only a matter of time','my green mantle covers everything again','I shall become a vast green jungle'],features:['STANZA-BY-STANZA','POETRY TOOLKIT','POETIC DEVICES','WORDS TO KNOW','THEMES','TEXTBOOK PREPARATION','Long Answers','GROUP DISCUSSION','COMPOSITION','WORD STUDY','Correct spelling','Match words with meanings','Adjective formation with -y','GRAMMAR • FIGURE OF SPEECH','Simile','Metaphor','ACTIVITY','TRANSLATION','function Learn({onMode})','<PanoramaTimedQuiz mode={mode} title={poem.title}']});
...
console.log('English poetry QA passed: Chapters 1–7 include source-supported learning sections, chapter-contract Challenge banks, derived 20 Final Test banks, Chapter 7 has 29 ordered line meanings, option integrity, shared timed engine, navigation and App routing.');
