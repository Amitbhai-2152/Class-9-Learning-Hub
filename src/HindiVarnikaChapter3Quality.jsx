...
['वर्षा की कामना','जट-जटिन को वर्षा की कामना से जुड़े लोकनृत्य के रूप में पढ़ाया जाता है।'],
...
['डोमकच','डोमकच का एक अन्य नाम जलुआ बताया जाता है और इसका संबंध नवादा क्षेत्र से जोड़ा जाता है।'],
...
['जट-जटिन से संबंधित प्रस्तुति में किसकी प्रमुख भागीदारी का उल्लेख है?',['स्त्रियों की','सैनिकों की','राजाओं की','व्यापारियों की'],0,'पाठ-संबंधी सामग्री में स्त्री भागीदारी का उल्लेख है।'],
['झिझिया में नर्तकियाँ सामान्यतः किस रूप में नृत्य करती हैं?',['घेरे में','अकेले','बैठकर','सीढ़ियों पर'],0,'झिझिया में सामूहिक वृत्ताकार प्रस्तुति का वर्णन है।'],
['करिया-झूमर में लड़कियाँ क्या करती हैं?',['हाथ पकड़कर वृत्ताकार नृत्य','चित्र बनाती हैं','केवल गीत लिखती हैं','वाद्य बेचती हैं'],0,'करिया-झूमर सामूहिक वृत्ताकार नृत्य है।'],
['डोमकच का दूसरा नाम क्या बताया गया है?',['जलुआ','झिझिया','जट-जटिन','पँवरिया'],0,'डोमकच का एक अन्य नाम जलुआ बताया गया है।'],
['डोमकच को किस क्षेत्र से जोड़ा गया है?',['नवादा','सारण','चंपारण','पूर्णिया'],0,'पाठ-संबंधी सामग्री में नवादा का उल्लेख है।'],
['पँवरिया किस समुदाय से जुड़ा नृत्य माना गया है?',['मल्लाह','कुम्हार','लोहार','नाई'],0,'पँवरिया को मल्लाह समुदाय से जोड़ा गया है।'],
...
['गुँडिया की कठिन प्रस्तुति में एक नर्तक क्या कर सकता है?',['पुरुष और स्त्री दोनों भूमिकाएँ','दो अलग वाद्य बजाना','चार भाषाएँ बोलना','चित्र बनाना'],0,'एक नर्तक दोनों भूमिकाएँ प्रस्तुत कर सकता है।'],
['खेलाडिनों का संबंध किस क्षेत्र की पेशेवर नृत्यपरंपरा से बताया जाता है?',['गया-मगध','मिथिला','भोजपुर','सीमांचल'],0,'खेलाडिनों का उल्लेख गया-मगध प्रसंग में मिलता है।'],
...
['ज्योतिरीश्वर ठाकुर किस सांस्कृतिक क्षेत्र से जुड़े महत्त्वपूर्ण नाम हैं?',['मिथिला','मालवा','कश्मीर','गुजरात'],0,'ज्योतिरीश्वर ठाकुर का संबंध मिथिला से है।'],
...
['हरि उप्पल ने किन दो नृत्य-परंपराओं की विशेषताओं को साधने का प्रयास किया?',['कथकली और मणिपुरी','कथक और ओडिसी','भरतनाट्यम और कुचिपुड़ी','छऊ और कथक'],0,'पाठ-संबंधी सामग्री में कथकली और मणिपुरी का उल्लेख है।'],
['नगेन्द्र मोहिनी किन दो शास्त्रीय नृत्यरूपों से जुड़ी थीं?',['कथक और भरतनाट्यम','कथकली और मणिपुरी','ओडिसी और छऊ','कुचिपुड़ी और कथकली'],0,'नगेन्द्र मोहिनी कथक और भरतनाट्यम से जुड़ी थीं।'],
...
['बिहार की नृत्य-विविधता किन सांस्कृतिक क्षेत्रों से समझी जा सकती है?',['मिथिला, मगध, गया और भोजपुर','केवल दिल्ली','केवल पंजाब','केवल राजस्थान'],0,'इन क्षेत्रों की अलग परंपराएँ विविधता दिखाती हैं।'],
...
['जट-जटिन किस प्रकार का लोकनृत्य माना जाता है?',['संवादमूलक','केवल वाद्यात्मक','केवल चित्रात्मक','केवल एकल पाठ'],0,'जट-जटिन संवाद और भूमिका-अभिनय वाला लोकनृत्य है।'],
['झिझिया की सामूहिक शैली में कौन-सी आकृति प्रमुख है?',['वृत्त','त्रिभुज','सीधी अकेली रेखा','चौकोर मेज'],0,'झिझिया के वर्णन में घेरे का उल्लेख है।'],
['करिया-झूमर की प्रस्तुति किस विशेषता को दिखाती है?',['सामूहिक समन्वय','एकांत अध्ययन','चित्रांकन','लेखन'],0,'हाथ पकड़कर वृत्त में नृत्य सामूहिक समन्वय दिखाता है।'],
['पँवरिया का अध्ययन हमें क्या समझने में मदद करता है?',['समुदाय-विशिष्ट नृत्यपरंपरा','चित्रकला का इतिहास','सिनेमा तकनीक','व्याकरण'],0,'यह नृत्य और समुदाय के संबंध का उदाहरण है।'],
['भिखारी ठाकुर के संदर्भ से बिहार की कौन-सी सांस्कृतिक विशेषता स्पष्ट होती है?',['लोक-अभिव्यक्ति की विविधता','केवल शास्त्रीयता','केवल चित्रकला','केवल स्थापत्य'],0,'उनका संदर्भ भोजपुरी लोक-अभिव्यक्ति की विविधता दिखाता है।'],
['लोकनृत्य संरक्षण का सबसे उपयोगी माध्यम कौन-सा है?',['प्रशिक्षण और दस्तावेजीकरण','केवल परीक्षा','केवल विज्ञापन','केवल मंच-सज्जा'],0,'प्रशिक्षण, दस्तावेजीकरण और नई पीढ़ी की भागीदारी संरक्षण में मदद करते हैं।']
];

function pickQuestions(mode){const count=MODES[mode].count;return QUESTIONS.slice(0,count);}
export default function HindiVarnikaChapter3Quality({topic,onBack,onComplete,onNavigate,initialMode='learn'}){
 const [mode,setMode]=useState(initialMode==='learn'?'learn':initialMode);
 const [index,setIndex]=useState(0); const [answers,setAnswers]=useState({}); const [submitted,setSubmitted]=useState(false);
 const [seconds,setSeconds]=useState(null);
 const questions=useMemo(()=>mode==='learn'?[]:pickQuestions(mode),[mode]);
 const duration=HINDI_MODE_TIMING[mode]?.minutes*60||null;
 useEffect(()=>{setSeconds(duration); if(mode==='learn')return; const id=setInterval(()=>setSeconds(s=>s==null?null:Math.max(0,s-1)),1000); return()=>clearInterval(id)},[mode,duration]);
 const changeMode=m=>{setMode(m);setIndex(0);setAnswers({});setSubmitted(false)};
 const prev=ORDER[ORDER.indexOf(TITLE)-1],next=ORDER[ORDER.indexOf(TITLE)+1];
 if(mode==='learn')return <div className="hindi-learn hindi-varnika-learn"><div className="hindi-learn-banner"><span>वर्णिका भाग 1 • पाठ 3</span><h2>{TITLE}</h2><p>बिहार की लोक और शास्त्रीय नृत्यपरंपराओं को उदाहरणों, प्रमुख नामों और परीक्षा-योग्य तथ्यों के साथ समझें।</p></div><section className="hindi-ch1-panel"><div className="hindi-ch1-panel-head"><h3>📖 गहराई से सीखें</h3><span>{POINTS.length} मुख्य बिंदु</span></div><div className="hindi-learn-grid">{POINTS.map(([h,b],i)=><section key={h}><h3>{i+1}. {h}</h3><p>{b}</p></section>)}</div></section><div className="hindi-ch1-callout"><strong>🎯 परीक्षा फोकस</strong><p>जट-जटिन, झिझिया, करिया-झूमर, डोमकच, पँवरिया, गुँडिया तथा हरि उप्पल, नगेन्द्र मोहिनी और भिखारी ठाकुर जैसे नामों को उनके मुख्य तथ्य के साथ याद करें।</p></div><div className="hindi-actions"><button type="button" className="secondary-btn pressable" onClick={onBack}>← वर्णिका सूची</button><div><button type="button" className="secondary-btn pressable" onClick={()=>changeMode('practice')}>📝 अभ्यास</button><button type="button" className="primary-btn pressable" onClick={()=>{markHindiModeCompleted(topic?.id||'varnika-3','learn');onComplete?.('learn')}}>✓ सीखना पूरा करें</button></div></div></div>;
 if(submitted){const score=questions.reduce((s,q,i)=>s+(answers[i]===q[2]?1:0),0);return <div className="hindi-learn hindi-varnika-learn"><section className="hindi-ch1-panel"><div className="hindi-score"><span>🎯</span><strong>{score}/{questions.length}</strong><small>सही उत्तर</small><p>{score>=Math.ceil(questions.length*.7)?'अच्छी तैयारी है।':'गलतियों की समीक्षा करके फिर प्रयास करें।'}</p></div><div className="hindi-review">{questions.map((q,i)=><article className={`hindi-review-item ${answers[i]===q[2]?'ok':'wrong'}`} key={q[0]}><div className="hindi-review-num">{i+1}</div><div><strong>{q[0]}</strong><p><b>आपका उत्तर:</b> {answers[i]!=null?q[1][answers[i]]:'उत्तर नहीं दिया'}</p><p><b>सही उत्तर:</b> {q[1][q[2]]}</p><span>{q[3]}</span></div></article>)}</div><div className="hindi-actions"><button type="button" className="secondary-btn pressable" onClick={()=>{setSubmitted(false);setIndex(0);setAnswers({})}}>↻ फिर से दें</button>{prev&&<button type="button" className="secondary-btn pressable" onClick={()=>onNavigate?.(prev)}>← पिछला</button>}{next&&<button type="button" className="primary-btn pressable" onClick={()=>onNavigate?.(next)}>अगला →</button>}<button type="button" className="secondary-btn pressable" onClick={onBack}>वर्णिका सूची</button></div></section></div>}
