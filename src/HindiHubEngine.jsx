...
function Assessment({data,mode,onBack,addXp,finishSession}){
  const questions=useMemo(()=>grammarBank[data.title]?makeGrammarQuestions(data):makeLiteratureQuestions(data,mode==='challenge'),[data,mode]);
