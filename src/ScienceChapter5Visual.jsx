...
const scenes={
  ...
  mitochondria:{title:'माइटोकॉन्ड्रिया',label:'कोशिकीय श्वसन से उपयोगी ऊर्जा उपलब्ध कराने में प्रमुख भूमिका',kind:'organelle',symbol:'ऊर्जा',items:['कोशिकीय श्वसन','ATP निर्माण','ऊर्जा की उपलब्धता']},
  plastid:{title:'हरितलवक',label:'हरितलवक में क्लोरोफिल होता है और प्रकाश संश्लेषण में भूमिका होती है',kind:'organelle',symbol:'प्रकाश',items:['क्लोरोफिल','प्रकाश संश्लेषण','पादप कोशिका']},
  er:{title:'अंतर्द्रव्यी जालिका',label:'झिल्लीदार जालिका — निर्माण और आंतरिक परिवहन से जुड़ी',kind:'er',items:['खुरदरी ER + राइबोसोम','चिकनी ER','आंतरिक परिवहन']},
  ...
  prokaryote:{title:'प्रोकैरियोटिक कोशिका',label:'सुस्पष्ट केंद्रक झिल्ली के बिना आनुवंशिक पदार्थ का क्षेत्र',kind:'prokaryote',items:['झिल्ली-बद्ध केंद्रक नहीं','सरल आंतरिक संगठन','उदाहरण: जीवाणु']},
  eukaryote:{title:'यूकैरियोटिक कोशिका',label:'झिल्ली-बद्ध केंद्रक और अनेक झिल्ली-बद्ध कोशिकांग',kind:'eukaryote',items:['सुस्पष्ट केंद्रक','झिल्ली-बद्ध कोशिकांग','पौधे और जन्तु']},
  ...
  division:{title:'कोशिका विभाजन',label:'वृद्धि और नई कोशिकाओं के निर्माण में कोशिका विभाजन की भूमिका',kind:'division',items:['मूल कोशिका','आनुवंशिक पदार्थ का वितरण','नई कोशिकाएँ']}
};
...
function OrganelleDiagram({symbol}){return <div style={styles.stage}><div style={{width:210,minHeight:100,borderRadius:40,border:'3px solid #8fc4ba',display:'grid',placeItems:'center',background:'#eff9f7',textAlign:'center',fontWeight:900,color:'#2f6e67',padding:16}}>{symbol}<small style={{display:'block',fontWeight:700,marginTop:4}}>कार्य-केंद्रित संकेत</small></div></div>}
function ERDiagram(){return <div style={styles.stage}><div style={{display:'grid',gap:7,width:'min(100%,420px)'}}>{['~~~~ राइबोसोमयुक्त खुरदरी ER ~~~~','~~~~ झिल्लीदार नलिकाएँ ~~~~','~~~~ चिकनी ER ~~~~'].map((x,i)=><div key={x} style={{padding:'9px 12px',border:'2px solid #9bcfc6',borderRadius:20,background:i===0?'#e9f6f3':'#f6fbfa',color:'#3d625d',fontWeight:850,textAlign:'center'}}>{x}</div>)}</div></div>}
...
function VacuoleDiagram(){return <div style={styles.stage}><div style={{width:240,height:130,borderRadius:28,border:'3px solid #91c6bc',background:'#eaf7f4',display:'grid',placeItems:'center',textAlign:'center',color:'#39706a',fontWeight:900}}>केंद्रीय रिक्तिका<small>जल + घुले पदार्थ</small></div></div>}
function ProkEukDiagram({prok=false}){return <div style={{...styles.stage,display:'grid',gridTemplateColumns:'1fr 1fr',gap:14}}><div>{box('प्रोकैरियोटिक',{marginBottom:8})}<div style={styles.miniList}>{prok?'सुस्पष्ट केंद्रक नहीं':'सरल संगठन'}<br/>झिल्ली-बद्ध केंद्रक नहीं<br/>जीवाणु का उदाहरण</div></div><div>{box('यूकैरियोटिक',{marginBottom:8})}<div style={styles.miniList}>सुस्पष्ट केंद्रक<br/>झिल्ली-बद्ध कोशिकांग<br/>पौधे और जन्तु</div></div></div>}
function DivisionDiagram(){return <div style={styles.flow}><div style={styles.flowRow}>{box('मूल कोशिका')}<span style={styles.arrow}>→</span>{box('विभाजन',{background:'#eaf6f3'})}<span style={styles.arrow}>→</span>{box('नई कोशिकाएँ')}</div><p style={styles.note}>वृद्धि और नई कोशिकाओं के निर्माण में कोशिका विभाजन महत्वपूर्ण है।</p></div>}

const styles={stage:{minHeight:165,display:'grid',placeItems:'center',padding:16,border:'1px solid #d9e9e6',borderRadius:16,background:'#f7fcfb'},cellOuter:{width:'min(330px,82vw)',height:170,borderRadius:40,border:'5px solid #76afa6',background:'#f0f9f7',padding:10,boxSizing:'border-box',position:'relative'},cytoplasm:{width:'100%',height:'100%',borderRadius:32,background:'#e3f4ef',position:'relative',display:'grid',placeItems:'center'},nucleus:{width:90,height:90,borderRadius:'50%',background:'#c5e4dc',border:'3px solid #66a79e',display:'grid',placeItems:'center',textAlign:'center',fontWeight:900,color:'#285f58'},labelTop:{position:'absolute',left:12,top:12,fontSize:12,fontWeight:800,color:'#4f756f'},labelBottom:{position:'absolute',bottom:-24,left:0,right:0,textAlign:'center',fontSize:12,fontWeight:850,color:'#3f6d66'},miniList:{padding:12,border:'1px solid #dbe9e6',borderRadius:12,background:'#fbfefd',lineHeight:1.8,color:'#58716d',fontSize:13,fontWeight:750,textAlign:'center'},flow:{width:'100%',textAlign:'center'},flowRow:{display:'grid',gridTemplateColumns:'minmax(100px,1fr) 28px minmax(100px,1fr) 28px minmax(100px,1fr)',alignItems:'center',gap:6},arrow:{fontSize:22,fontWeight:900,color:'#43847c'},note:{margin:'13px 0 0',color:'#617873',fontSize:13,lineHeight:1.6},layers:{width:'min(360px,90vw)',padding:14,border:'2px solid #99c7be',borderRadius:20,background:'#f0f8ed',textAlign:'center'}};

export function ScienceChapter5Visual({kind='cell'}){
 const scene=scenes[kind]||scenes.cell;
 let diagram=<CellDiagram/>;
 if(scene.kind==='compare')diagram=<CompareDiagram/>;
 if(scene.kind==='compareCell')diagram=<CompareDiagram plant/>;
 ...
 if(scene.kind==='prokaryote'||scene.kind==='eukaryote')diagram=<ProkEukDiagram prok={kind==='prokaryote'}/>;
