...
function QuestionPalette({list,index,answers,onSelect}){
  return <section className="hindi-question-palette" aria-label="अभ्यास प्रश्न नेविगेशन">
    <div className="hindi-question-palette-head"><div><strong>प्रश्न नेविगेशन</strong><small>किसी भी प्रश्न पर सीधे जाएँ</small></div><span>{Object.keys(answers).length}/{list.length} हल</span></div>
