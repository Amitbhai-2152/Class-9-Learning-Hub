...
createRoot(document.getElementById('root')).render(<React.StrictMode><AuthProvider><AppErrorBoundary><BuildVersionRefresh/><FreshLanguageSkillsNavigation/><XPCompletionBoundary><RootRouter/></XPCompletionBoundary><DailyExamPlanMount/><XPAchievementOverlay/><GlobalAuthEntry/><MobileHomeNav/></AppErrorBoundary></AuthProvider></React.StrictMode>);