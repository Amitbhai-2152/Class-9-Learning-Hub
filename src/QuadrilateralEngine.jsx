...
const challenge=[
 {q:'समांतर चतुर्भुज ABCD में ∠A=(3x+15)° तथा ∠C=(5x−25)° हैं। x का मान क्या है?',options:['10','15','20','25'],answer:2,explain:'विपरीत कोण बराबर होते हैं। इसलिए 3x+15=5x−25, अतः 2x=40 और x=20।'},
 {q:'समांतर चतुर्भुज के विकर्ण O पर मिलते हैं। यदि AO=(4x−3) cm और OC=(2x+9) cm है, तो x का मान क्या है?',options:['4','5','6','7'],answer:2,explain:'विकर्ण एक-दूसरे को समद्विभाजित करते हैं। इसलिए 4x−3=2x+9, अतः 2x=12 और x=6।'},
 {q:'समांतर चतुर्भुज में एक कोण दूसरे से 50° अधिक है। दोनों कोण कौन-से हैं?',options:['65°,115°','60°,120°','70°,110°','75°,105°'],answer:0,explain:'आसन्न कोणों का योग 180° और अंतर 50° है। छोटे कोण को x लें: x+(x+50)=180, इसलिए x=65° और दूसरा 115°।'},
 ...
 {q:'एक वर्ग का विकर्ण 12√2 cm है। उसकी भुजा कितनी होगी?',options:['6 cm','12 cm','18 cm','24 cm'],answer:1,explain:'वर्ग में विकर्ण=भुजा×√2। इसलिए भुजा=(12√2)/√2=12 cm।'},
 {q:'समांतर चतुर्भुज की एक जोड़ी विपरीत भुजाएँ 3x+4 और 5x−10 हैं। x कितना है?',options:['5','6','7','8'],answer:2,explain:'विपरीत भुजाएँ बराबर होती हैं। 3x+4=5x−10 ⇒ 2x=14 ⇒ x=7।'},
 {q:'किस गुण से किसी चतुर्भुज के समांतर चतुर्भुज होने की पुष्टि की जा सकती है?',options:['एक कोण 90° है','विकर्ण एक-दूसरे को समद्विभाजित करते हैं','दो भुजाएँ बराबर हैं','एक विकर्ण लंबा है'],answer:1,explain:'यदि चतुर्भुज के विकर्ण एक-दूसरे को समद्विभाजित करते हैं, तो वह समांतर चतुर्भुज होता है।'},
 {q:'यदि किसी समांतर चतुर्भुज के चारों कोण बराबर हों, तो प्रत्येक कोण कितना होगा?',options:['45°','60°','90°','120°'],answer:2,explain:'चारों कोणों का योग 360° है और सभी बराबर हैं। इसलिए प्रत्येक कोण 360°/4=90° होगा।'}
];
