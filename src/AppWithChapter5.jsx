...
import {EnglishPanoramaPoem7} from './english/EnglishPanoramaPoem7.jsx';
...
export default function AppWithChapter5(){
  ...
  if(chapter===23){const mode=routeMode();return <EnglishPanoramaPoem7 initialMode={mode==='learn'?'':mode} onBack={back} addXp={addXp} finishSession={finishSession}/>;}
