...
import EnglishPanoramaChapter8Final from './english/EnglishPanoramaChapter8Final.jsx';
...
export default function AppWithChapter5(){
  ...
  if(chapter===8)return <EnglishPanoramaChapter8Final initialMode={routeMode()} onBack={back} addXp={addXp} finishSession={finishSession}/>;
  return <App/>;
}
