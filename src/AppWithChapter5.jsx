...
const getChapter=()=>{if(typeof window==='undefined')return 0;const p=new URLSearchParams(window.location.search);if(p.get('subject')!=='english')return 0;if(p.get('panorama6')==='1')return 6;if(p.get('panorama5')==='1')return 5;if(p.get('page')==='chapter'){const n=Number(p.get('chapter'));if(Number.isInteger(n)&&n===12)return 5;if(Number.isInteger(n)&&n===13)return 6}return 0};
