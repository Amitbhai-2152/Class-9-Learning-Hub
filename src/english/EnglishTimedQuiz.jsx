...
const timeFor=mode=>mode==='practice'?30:mode==='challenge'?25:20;

export default function EnglishTimedQuiz({title='English Quiz',mode='test',getBank,onModeChange=()=>{},onBack=()=>{},addXp=()=>{},finishSession=()=>{}}){
