...
export default function EnglishGenericLanguageSkillsQuiz({topicId='agreement',onBack,addXp,finishSession}){
 ...
 const getBank=useMemo(()=>mode=>{if(topicId==='determiners')return dedicatedBank?.[mode]||[];return dedicatedBank?.[mode]||topic?.[mode]||topic?.practice||[]},[topic,topicId,dedicatedBank]);
