...
const challenge=[
 {q:'आँकड़े 4, 8, 8, 10, 20 हैं। माध्य और मध्यिका में कौन बड़ा है?',options:['माध्य','मध्यिका','दोनों बराबर','कहा नहीं जा सकता'],answer:0,explain:'माध्य=(4+8+8+10+20)÷5=50÷5=10, जबकि मध्यिका=8। इसलिए माध्य बड़ा है।'},
 {q:'एक सारणी में किसी चार मानों की बारम्बारताएँ 7, 5, 4 और 9 हैं। कुल आँकड़े कितने हैं?',options:['20','24','25','26'],answer:2,explain:'7+5+4+9=25, इसलिए कुल 25 आँकड़े हैं।'},
 {q:'यदि 6 विद्यार्थियों के अंकों का माध्य 18 है और पाँच अंकों का योग 82 है, तो छठा अंक क्या है?',options:['24','26','28','30'],answer:1,explain:'कुल योग=18×6=108। छठा अंक=108−82=26। इसलिए सही विकल्प 26 है।'},
 {q:'आँकड़े 3, 3, 4, 5, 5, 5, 8, 20 में बाहरी मान का प्रभाव कम करने के लिए कौन-सा माप अधिक उपयुक्त हो सकता है?',options:['मध्यिका','केवल माध्य','परास','बारम्बारता'],answer:0,explain:'20 एक बहुत बड़ा बाहरी मान है। मध्यिका ऐसे मान से माध्य की तुलना में कम प्रभावित होती है।'}
];
function shuffle(list){const a=[...list];for(let i=a.length-1;i>0;i--){const j=Math.floor(Math.random()*(i+1));[a[i],a[j]]=[a[j],a[i]]}return a}
export function StatisticsEngine({chapter,mode,onBack,addXp}){
 const isTest=mode==='test';
 const questions=useMemo(()=>isTest?shuffle(chapter14Practice).slice(0,15):mode==='challenge'?challenge:chapter14Practice,[mode,isTest]);
