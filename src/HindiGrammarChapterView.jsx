...
export function HindiGrammarChapterView({topic,initialMode='learn',onBack,onComplete,onNavigate}){
  ...
  if(showTopicPage)return topic?.id==='grammar-gr5'?<HindiParagraphTopicPage onBack={onBack}/>:topic?.id==='grammar-gr6'?<HindiGenderTopicPage onBack={onBack}/>:topic?.id==='grammar-gr7'?<HindiNumberTopicPage onBack={onBack}/>:topic?.id==='grammar-gr8'?<HindiTenseTopicPage onBack={onBack}/>:topic?.id==='grammar-gr9'?<HindiVoiceTopicPage onBack={onBack}/>:topic?.id==='grammar-gr10'?<HindiSandhiTopicPage onBack={onBack}/>:topic?.id==='grammar-gr11'?<HindiSamasTopicPage onBack={onBack}/>:topic?.id==='grammar-gr12'?<HindiSynonymAntonymTopicPage onBack={onBack}/>:topic?.id==='grammar-gr13'?<HindiIdiomsOneWordTopicPage onBack={onBack}/>:<HindiGrammarTopicPage topic={topic} onBack={onBack}/>;
