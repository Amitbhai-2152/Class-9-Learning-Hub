...
import './math-chapter-visual.css';
...
function Scene({type}){
  ...
  if(type==='bars')return <svg viewBox="0 0 420 220" className="chapter-scene-svg" aria-hidden="true"><line x1="55" y1="185" x2="370" y2="185" className="scene-axis"/><g className="scene-bars"><rect x="78" y="126" width="42" height="59" rx="6"/><rect x="138" y="92" width="42" height="93" rx="6"/><rect x="198" y="48" width="42" height="137" rx="6"/><rect x="258" y="108" width="42" height="77" rx="6"/></g><text x="74" y="207" className="scene-label">मान</text><text x="292" y="207" className="scene-label">बारम्बारता</text></svg>;
  ...
  if(type==='quad')return <svg viewBox="0 0 420 220" className="chapter-scene-svg" aria-hidden="true"><polygon points="105,62 314,62 350,170 72,170" className="scene-fill quad"/><line x1="105" y1="62" x2="350" y2="170" className="scene-diagonal"/><line x1="314" y1="62" x2="72" y2="170" className="scene-diagonal second"/></svg>;
  if(type==='angles')return <svg viewBox="0 0 420 220" className="chapter-scene-svg" aria-hidden="true"><line x1="70" y1="170" x2="350" y2="55" className="scene-axis"/><line x1="70" y1="55" x2="350" y2="170" className="scene-axis second"/><circle cx="210" cy="112" r="7" className="scene-point"/></svg>;
  if(type==='solid')return <svg viewBox="0 0 420 220" className="chapter-scene-svg" aria-hidden="true"><rect x="90" y="68" width="150" height="105" rx="8" className="scene-solid"/><ellipse cx="275" cy="120" rx="38" ry="52" className="scene-cylinder"/><text x="92" y="198" className="scene-label">बाहरी सतह</text><text x="272" y="198" className="scene-label">आयतन</text></svg>;
...
export function MathChapterVisual({chapter}){const scene=scenes[chapter]||scenes['संख्या पद्धति'];return <div className={`math-chapter-visual visual-${scene.type}`}><div className="math-chapter-visual-head"><div><span>दृश्य समझ</span><strong>{scene.title}</strong></div><span>● एनिमेशन</span></div><Scene type={scene.type}/><p>{scene.caption}</p></div>;}
