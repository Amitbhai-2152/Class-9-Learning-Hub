...
export const hindiStudyRegistry={
  ...
  g10:{lesson:hindiChapter10Lesson,practice:hindiChapter10PracticeQuestions,challenge:hindiChapter10Challenge,test:hindiChapter10TestQuestions},
  g11:{lesson:hindiChapter11Lesson,practice:hindiChapter11PracticeQuestions,challenge:hindiChapter11Challenge,test:hindiChapter11TestQuestions},
  g12:{lesson:hindiChapter12Lesson,practice:hindiChapter12PracticeQuestions,challenge:hindiChapter12Challenge,test:hindiChapter12TestQuestions},
  p1:{lesson:hindiPoetry1Lesson,practice:hindiPoetry1PracticeQuestions,challenge:hindiPoetry1Challenge,test:hindiPoetry1TestQuestions},
  p2:{lesson:hindiPoetry2Lesson,practice:hindiPoetry2PracticeQuestions,challenge:hindiPoetry2Challenge,test:hindiPoetry2TestQuestions},
  p3:{lesson:hindiPoetry3Lesson,practice:hindiPoetry3PracticeQuestions,challenge:hindiPoetry3Challenge,test:hindiPoetry3TestQuestions},
  p4:{lesson:hindiPoetry4Lesson,practice:hindiPoetry4PracticeQuestions,challenge:hindiPoetry4Challenge,test:hindiPoetry4TestQuestions},
  p5:{lesson:hindiPoetry5Lesson,practice:hindiPoetry5PracticeQuestions,challenge:hindiPoetry5Challenge,test:hindiPoetry5TestQuestions},
  p6:{lesson:hindiPoetry6Lesson,practice:hindiPoetry6PracticeQuestions,challenge:hindiPoetry6Challenge,test:hindiPoetry6TestQuestions},
  p7:{lesson:hindiPoetry7Lesson,practice:hindiPoetry7PracticeQuestions,challenge:hindiPoetry7Challenge,test:hindiPoetry7TestQuestions},
  p8:{lesson:hindiPoetry8Lesson,practice:hindiPoetry8PracticeQuestions,challenge:hindiPoetry8ChallengeQuestions,test:hindiPoetry8TestQuestions},
