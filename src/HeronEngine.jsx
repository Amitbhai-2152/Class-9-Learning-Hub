...
import {chapter12Practice} from './chapter12Practice';

const challenge=[
 {q:'एक त्रिभुज की भुजाएँ 13 cm, 14 cm और 15 cm हैं। यदि उसका क्षेत्रफल 84 cm² है, तो 14 cm को आधार मानने पर ऊँचाई कितनी होगी?',options:['10 cm','12 cm','14 cm','16 cm'],answer:1,explain:'84=1/2×14×h। इसलिए h=168÷14=12 cm।'},
 {q:'किसी त्रिभुज का अर्धपरिमाप 15 cm है और दो भुजाएँ 8 cm तथा 10 cm हैं। तीसरी भुजा कितनी है?',options:['5 cm','7 cm','12 cm','13 cm'],answer:1,explain:'a+b+c=30। c=30−8−10=12 cm। सही विकल्प 12 cm है।',_fix:'answer=2'},
 {q:'एक त्रिभुज की भुजाएँ 7 cm, 8 cm और 9 cm हैं। हीरोन सूत्र में वर्गमूल के अंदर का गुणनफल क्या होगा?',options:['12×5×4×3','24×7×8×9','12×7×8×9','6×5×4×3'],answer:0,explain:'s=12, इसलिए s−7=5, s−8=4, s−9=3।'}
];
function shuffle(list){const a=[...list];for(let i=a.length-1;i>0;i--){const j=Math.floor(Math.random()*(i+1));[a[i],a[j]]=[a[j],a[i]]}return a}
export function HeronEngine({chapter,mode,onBack,addXp}){
 const isTest=mode==='test';
 const questions=useMemo(()=>isTest?shuffle(chapter12Practice).slice(0,15):mode==='challenge'?challenge:chapter12Practice,[mode,isTest]);
