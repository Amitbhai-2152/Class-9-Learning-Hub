...
import {chapter10Practice} from './chapter10Practice';

const challenge=[
 {q:'किसी वृत्त की त्रिज्या 13 cm है और एक जीवा की केंद्र से दूरी 5 cm है। जीवा की लंबाई कितनी होगी?',options:['10 cm','12 cm','24 cm','26 cm'],answer:2,explain:'केंद्र से जीवा के मध्यबिंदु तक 5 cm है। आधी जीवा = √(13²−5²)=12 cm, इसलिए पूरी जीवा = 24 cm।'},
 {q:'एक ही वृत्त में दो जीवाओं की लंबाई बराबर है। पहली जीवा की केंद्र से दूरी 7 cm है। दूसरी जीवा की दूरी क्या होगी?',options:['5 cm','7 cm','14 cm','निर्धारित नहीं'],answer:1,explain:'एक ही वृत्त में बराबर जीवाएँ केंद्र से समान दूरी पर होती हैं।'},
 {q:'एक वृत्त की दो जीवाओं की केंद्र से दूरियाँ 6 cm और 8 cm हैं। कौन-सी जीवा बड़ी होगी?',options:['8 cm दूरी वाली','6 cm दूरी वाली','दोनों बराबर','निर्धारित नहीं'],answer:1,explain:'केंद्र के पास वाली जीवा बड़ी होती है। इसलिए 6 cm दूरी वाली जीवा बड़ी होगी।'},
 {q:'किसी जीवा की लंबाई 24 cm है और केंद्र से उसकी दूरी 5 cm है। वृत्त की त्रिज्या 13 cm है। यह जीवा संभव क्यों है?',options:['क्योंकि 12²+5²=13²','क्योंकि 24+5=13','क्योंकि 12+5=13','क्योंकि 24²−5²=13'],answer:0,explain:'आधी जीवा 12 cm है। समकोण त्रिभुज में 12²+5²=144+25=169=13²।'},
 {q:'यदि केंद्र से किसी जीवा पर खींचा गया लंब जीवा को समद्विभाजित करता है, तो इसके विलोम में क्या कहा जा सकता है?',options:['जीवा का मध्यबिंदु केंद्र से जोड़ने पर जीवा पर लंब मिलता है','जीवा व्यास नहीं है','त्रिज्या शून्य है','चाप आधी हो जाती है'],answer:0,explain:'जीवा के मध्यबिंदु को केंद्र से जोड़ने पर प्राप्त रेखाखंड जीवा पर लंब होता है।'}
];
function shuffle(list){const a=[...list];for(let i=a.length-1;i>0;i--){const j=Math.floor(Math.random()*(i+1));[a[i],a[j]]=[a[j],a[i]]}return a}
export function CirclesEngine({chapter,mode,onBack,addXp}){
 const isTest=mode==='test';
 const questions=useMemo(()=>isTest?shuffle(chapter10Practice).slice(0,15):mode==='challenge'?challenge:chapter10Practice,[mode,isTest]);
